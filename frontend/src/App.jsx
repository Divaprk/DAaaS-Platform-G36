                               ...
                               return (
                                <button
                                  ...
                                  className={`text-left px-2 py-1.5 rounded text-[9px] transition-all ${
                                    selectedCourses.includes(compositeId) ? 'bg-cyan-500 text-black font-bold' : 'text-zinc-600 hover:text-zinc-300'
                                  }`}
                                >
                                  {course}
                                </button>
              ...
              {viewMode === 'categories' && allCategories.filter(cat => cat.toLowerCase().includes(searchTerm.toLowerCase())).map(cat => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all ${
                    selectedCategories.includes(cat) ? 'bg-purple-500 text-black shadow-lg shadow-purple-500/20' : 'bg-zinc-800/50 text-zinc-400 hover:bg-zinc-800 hover:text-zinc-200'
                  }`}
                >
                  {cat}
                </button>
